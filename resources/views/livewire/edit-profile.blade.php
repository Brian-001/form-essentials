                ...
                <div class="flex justify-center items-center mt-8 mb-8">
                    <form wire:submit="save" class="w-1/2 max-w-lg bg-white p-8 rounded-lg shadow-md">
                        <div class="mb-4">
                            ...
                            <input wire:model="username" @class([ 'px-3 py-2 rounded-md w-full focus:border-emerald-700' ,
                        ...
                        <label class="flex flex-col gap-2">
                            <h1 class="font-medium text-base">Country</h1>
                            <select wire:model.blur="country"
                            @class([
                            'px-3 py-2 rounded-lg mb-6 bg-emarald-500',
                            $errors->missing('country') ? 'border border-gray-300' : '',
